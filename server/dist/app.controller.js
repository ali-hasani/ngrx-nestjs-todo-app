...
const todos_manager_1 = require("./todos-manager");
let AppController = class AppController {
    constructor(appService) {
        this.appService = appService;
        this.manager = null;
        this.manager = todos_manager_1.default();
    }
    getAll() {
    ...
    updateTodo(params, todo) {
        const id = params.id;
        return this.manager.updateTodo(Object.assign(Object.assign({}, todo), { id }));
    }
};
__decorate([
    common_1.Get(),
